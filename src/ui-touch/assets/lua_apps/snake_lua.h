...
// Snake, in Lua — the wada.* reference app (LUA_APPS.md). Embedded so the game
// works with no storage; seeded to /apps/snake.lua so users can open and edit
// it (the host prefers the file copy — instant moddability).
#pragma once

static const char kSnakeLua[] = R"luaapp(
